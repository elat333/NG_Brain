          ...
          <div className="space-y-2 relative">
            <label className="text-[10px] font-bold text-gray-400 uppercase tracking-wider ml-1 flex items-center gap-1.5">
              ...
              {!canEditActualHours && (
                <span 
                  title={
                    !isResponsibleMember && !isProcessLeader
                      ? "Solo el responsable asignado, líder del proceso o administrador pueden registrar horas reales"
                      : "Las horas reales se pueden registrar cuando la tarea está En Proceso o Para Revisión"
                  }
                  className="ml-auto flex items-center cursor-help"
                >
