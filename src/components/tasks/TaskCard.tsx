...
import { Trash2, Calendar, Clock, MessageSquare, AlertCircle, GripVertical } from 'lucide-react';
...
export interface TaskCardProps {
  ...
  // Drag & drop vertical intra-columna
  onDragStartCard?: (e: React.DragEvent, task: Task) => void;
  onDragOverCard?: (e: React.DragEvent, task: Task) => void;
  onDragLeaveCard?: (e: React.DragEvent, task: Task) => void;
  onDropCard?: (e: React.DragEvent, task: Task) => void;
...
export const TaskCard: React.FC<TaskCardProps> = ({
  ...
  return (
    <div
      ...
      onDragLeave={(e) => onDragLeaveCard?.(e, task)}
      onDrop={(e) => onDropCard?.(e, task)}
    >
      {/* Indicador de Inserción Arriba */}
      {dropPosition === 'before' && (
        <div className="w-full h-1.5 bg-blue-500 rounded-full mb-1 shadow-sm shadow-blue-500/50 animate-pulse" />
      )}
      ...
      {dropPosition === 'after' && (
        <div className="w-full h-1.5 bg-blue-500 rounded-full mt-1 shadow-sm shadow-blue-500/50 animate-pulse" />
      )}
    </div>
  );
};
