...
import { Calendar, Clock, Lock, Plus, Trash2, CheckCircle2, Activity } from 'lucide-react';

interface StoryPlanningSectionProps {
  newTaskData: any;
...
export const StoryPlanningSection: React.FC<StoryPlanningSectionProps> = ({
  newTaskData,
  setNewTaskData,
  canEditPlanning,
  canEditExecution,
